...
export declare const Drawer: (({ zIndex, blurredBackground, opened, onClose, backgroundScroll, drawerDirection, className, children, ...restArticleProps }: DrawerProps) => import("react/jsx-runtime").JSX.Element) & {
