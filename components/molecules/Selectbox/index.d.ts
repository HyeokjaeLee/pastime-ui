...
export interface SelectboxProps<TValidOptionValue extends ValidOptionValue = ValidOptionValue, TMultiple extends boolean = false> extends Omit<InputProps, 'style' | 'className' | 'onChange' | 'value' | 'multiple' | 'type' | 'disabled'>, Pick<InputWrapProps, 'reversed' | 'className' | 'style'>, Pick<SelectProps<TValidOptionValue, TMultiple>, 'options' | 'float' | 'onChange' | 'value' | 'multiple'> {
