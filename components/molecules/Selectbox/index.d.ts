...
export interface SelectboxProps<TValidOptionValue extends ValidOptionValue = ValidOptionValue, TMultiple extends boolean = false, TCancelable extends boolean = true> extends Omit<InputProps, 'style' | 'className' | 'onChange' | 'value' | 'multiple' | 'type'>, Pick<InputWrapProps, 'reversed' | 'className' | 'style' | 'label' | 'fixedDarkMode'>, Pick<SelectProps<TValidOptionValue, TMultiple, TCancelable>, 'options' | 'float' | 'value' | 'multiple' | 'cancelable'> {
    size?: Size;
